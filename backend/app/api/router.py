...
from app.modules.admin.api.tracing import router as admin_tracing_router
...
v1_router.include_router(admin_tracing_router, prefix="/admin/tracing", tags=["admin"])
...
v2_router.include_router(admin_tracing_router, prefix="/admin/tracing", tags=["admin"])
